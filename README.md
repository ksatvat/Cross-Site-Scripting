...
### NOTE: This cheatsheet descibes XSS and provides a list of techniques to prevent or limit the impact of XSS. No single technique will solve XSS. Instead,  the combination of right defensive techniques help to prevent XSS.
